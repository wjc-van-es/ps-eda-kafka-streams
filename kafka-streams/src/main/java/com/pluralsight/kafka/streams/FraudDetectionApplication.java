...
public class FraudDetectionApplication {
    ...
    public static final String SOURCE_TOPIC = "payments";
    public static final String SINK_TOPIC = "validated-payments";
    ...
    public static void main(String[] args) {
        ...
        KStream<String, Order> stream = streamsBuilder.stream(SOURCE_TOPIC);
